...
createPost = async (title, description, date, score, type, owner) => {
    let new_post = Posts({ title, description, date, score, type, owner });
    await new_post.save();
    return { title, description, date, score, type, owner };
};
